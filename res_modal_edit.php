...
<div class="modal-dialog">
    <div class="modal-content">
		...
		<div class="modal-header">
			...
			<i class="">ATTENTION: When you reset, all the records will be initialised to zero (0)</i>
    	</div>

        <div class="modal-body">
        	<form id="form-update" action="res_edit_view.php" name="modal_popup" enctype="multipart/form-data" method="POST">
				...
				<div class="form-group" style="padding-bottom: 20px;">
                	<label for="Date">Investment</label>       
					<input type="text" name="investment" id="edit-sponsor" class="form-control" value="<?php echo $row['initial_invest']; ?>" disabled/>
                </div>
				<div class="form-group" style="padding-bottom: 20px;">
                	<label for="Date">Wallet</label>       
					<input type="text" name="wallet" id="edit-sponsor" class="form-control" value="<?php echo $row['user_stock']; ?>" disabled/>
                </div>
